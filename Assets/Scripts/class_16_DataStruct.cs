...
namespace KID.Class_16
{
    ...
    public class class_16_DataStruct : MonoBehaviour
    {
        ...
        public void Awake()
        {
            ...
            LogSystem.LogWithColor($"原本第一筆速度：{speeds[0]}", "#3f3");
            speeds[0] = 10;
            LogSystem.LogWithColor($"修改後第一筆速度：{speeds[0]}", "#3f3");
            // 陣列初始化後就無法增減長度
            // 添加一筆道具
            props.Add("寶劍");
            // 刪除第一筆道具
            ...
            LogSystem.LogWithColor($"容量：{props.Capacity}", "#f77");
            ...
            for (int i = 0; i < 20; i++)
            {
                ...
                LogSystem.LogWithColor($"容量：{numbers.Capacity}", "#f77");
            }
            #endregion
